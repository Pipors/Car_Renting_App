  ...
  return (
    <section className="space-y-4">
      <div>
        ...
        <p className="text-sm text-slate-600">Find available cars and start your booking request.</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-[280px_1fr]">
        ...
        <div>
          ...
          {!carsQuery.isLoading && cars.length === 0 ? <EmptyState title="No available cars found" /> : null}
